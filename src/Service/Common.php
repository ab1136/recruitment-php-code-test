<?php
    ...
    class Common
    {
        ...
        /**
         * @todo //优化函数体，拆分写两个请求接口的函数
         * @todo 缓存只缓存了Thrift接口成功的情况，第二个接口没缓存
         * @todo 缓存没有设置过期时间
         * geo helper 地址转换为坐标
         * @param $address
         * @return bool|string
        ...
        public function geoHelperAddress ($address,$merchant_id = '')
        {
            ...
            try
            {
                ...
                // requestLog：寫日志
                requestLog( 'Backend','Thrift','Http','phpgeohelper\\Geocoding->convert_addresses','https://geo-helper-hostr.ks-it.co',[[$address,
                                                                                                                                         $key]] );
