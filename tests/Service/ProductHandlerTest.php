<?php
    ...
    class ProductHandlerTest extends TestCase
    {
        ...
        {
            $result = (new ProductHandler)->sortProducts( $this->products,'dessert','desc' );
            
            $this->assertEquals( 40,$result[0]['price'] );
        }
        
        public function testCreateToTime ()
        {
            $result = (new ProductHandler)->createToTime( $this->products );
            
            $this->assertIsInt( $result[0]['create_at'] );
        }
    }